...
<body>
    <div class="container mt-5">
        <a href="tambahmah.php" class="btn btn-primary">Tambah Data Mahasiswa</a>
        <table class="table table-striped table-dark mt-3">
            ...
            <tr>
                ...
                <td><a href="editmah.php?id=<?= $row['id'] ?>" class="btn btn-warning">Edit</a></td>
                <td><a href="hapusmah.php?id=<?= $row['id'] ?>" class="btn btn-danger">Hapus</a></td>
